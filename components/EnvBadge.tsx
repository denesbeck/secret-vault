...
const EnvBadge = ({ readonly = false, uuid, api_key, archetype_uuid, name, app_uuid, owner_email }: EnvBadgeProps) => {
    ...
    const styles: Style = {
        'ef0462a1-5346-4a8a-803b-4a54a3791cf2': 'bg-teal-500 group-hover:bg-teal-400 hover:bg-teal-400',
        '4f1e8dad-4353-4e90-8887-f297f167344b': 'bg-blue-500 group-hover:bg-blue-400 hover:bg-blue-400',
        'f5d1c6d6-8c44-404b-bd58-69e13fcced00': 'bg-cyan-800 group-hover:bg-cyan-600 hover:bg-cyan-600',
    }
    ...
    return (
        <div
            ...
            } flex h-6 w-max animate-[textFocus_0.3s_ease-in-out] select-none items-center space-x-2 rounded-full bg-opacity-90 px-3 text-start text-white shadow-md ring-1 ring-white`}
        >
